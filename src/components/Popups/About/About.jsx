          ...
          <div className='flex flex-col justify-center relative px-auto'>
            ...
            <div className='flex justify-center flex-col text-center px-auto font-bold z-50'>
              ...
              <p className='flex justify-start text-start text-[#250340]'>
                Hello, I’m Rimshad Ahamed, Dedicated and skilled Front-End
                Developer with hands-on experience in React.js and Next.js using
                JavaScript and TypeScript. Seeking to leverage my expertise in
                web development to contribute effectively to innovative
                projects.
              </p>
            </div>
          </div>
