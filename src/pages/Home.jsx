  ...
  return (
    ...
    >
      ...
      <div className="absolute flex justify-center mt-60 z-30 gap-10 ">
        <button className="bg-white py-2 px-5 bg-opacity-60 text-black text-lg font-bold shadow-[0_0_20px_0px_#fff] outline-none border-none rounded-full">Hire Me</button>
        <button className="bg-white py-2 px-5 bg-opacity-60 text-black text-lg font-bold shadow-[0_0_20px_0px_#fff] outline-none border-none rounded-full">Download cv</button>
      </div>
    </div>
  );
};
